    ...
    namespace coro
    {
        ...
        namespace detail
        {
            ...
            public:
                ...
                struct FinalAwaiter
                {
                    ...
                    {
                        std::cout << "final index:" << h.promise().index << std::endl;
            ...
            public:
                ...
                auto await_transform(Awaitable &&awaitable)
                {
                    ...
                    std::cout<<"await_transform1"<<std::endl;
            ...
            public:
                ...
                struct AwaiterBase: public detail::LazyAwaiterBase<T>
                {
                        ...
                        std::coroutine_handle<> continuation) noexcept(!reschedule)
                    {
                        ...
                        std::cout << "suspend caller and start:" << this->_handle.promise() .index<< std::endl;
                ...
                struct TryAwaiter: public AwaiterBase
                {
                    ...
                    {
                        std::cout << "try resume:" << this->_handle.promise().index << std::endl;
                ...
                struct ValueAwaiter: public AwaiterBase
                {
                    ...
                    {
                        std::cout << "resume:" << this->_handle.promise().index << std::endl;
                ...
                explicit LazyBase(Handle coro, int i): _coro(coro), indexl(i) { std::cout << "create lazy:" << indexl << std::endl; }
        ...
        public:
            ...
            auto coAwait(Executor *ex)
            {
                // derived lazy inherits executor
                this->_coro.promise()._executor = ex;
                std::cout << "cowait index:" << this->_coro.promise().index <<" self:"<<this->indexl<< std::endl;
